...
Description:
    ...
    The checks verify data consistency, completeness, standardization,
    and business rules after the Silver ETL process has completed.
...
Quality Checks:
    ...
    • Invalid date ranges
    • Invalid date order
    • Sales and price consistency
    • Negative or missing values

Usage:
    • Execute this script after running load_silver.sql.
...
-- Expectation: No Results
-- Valid birth dates should be between 1926-01-01 and the current date.
